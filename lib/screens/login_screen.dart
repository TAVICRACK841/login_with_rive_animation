...
class _LoginScreenState extends State<LoginScreen> {
  ...
  void _onLogin() {
    ...
    if (eError == null && pError == null) {
      _trigSuccess?.fire(); // Respetando tu variable original _trigSuccess
    } else {
      _trigFail?.fire();    // Respetando tu variable original _trigFail
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: SafeArea(
        // NUEVO DE TU AMIGO: Evita que se quite el espacio de nudget y que el teclado marque error de Overflow
        child: SingleChildScrollView(
          child: Padding( //agregamos un padding para que la animación y los campos de texto no estén pegados a los bordes de la pantalla
            ...
            child: Column(
              children: [
                //Cambiamos "Expanded" por "SizedBox" de altura fija para que funcione con el ScrollView
                SizedBox(
                  height: 250, 
                  child: RiveAnimation.asset('animated_login_bear.riv',//agregamos la animación de Rive en la parte superior de la pantalla
                  stateMachines: const ['Login Machine'],//especificamos el nombre de la máquina de estados que queremos utilizar para controlar la animación de Rive
                  onInit: (artboart){
                ...
                TextField(
                  ...
                  decoration: InputDecoration(
                    errorText: emailError, // Muestra el error si lo hay
                    hintText: 'Email',
                ...
                TextField(
                  ...
                  decoration: InputDecoration(
                    errorText: passError, // NUEVO DE TU AMIGO: Muestra el error si lo hay
                    hintText: 'Password',
                ...
                MaterialButton(
                  ...
                  onPressed: _onLogin, // Llama a la nueva función de tu amigo
                  child: const Text(
                    "Login",
